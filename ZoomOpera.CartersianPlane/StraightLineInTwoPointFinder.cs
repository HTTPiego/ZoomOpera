namespace ZoomOpera.CartersianPlane
{
    public static class StraightLineInTwoPointFinder    
    {
        public static ImplicitFormStraightLine FindStraightLine(CartesianPoint firstPoint, CartesianPoint secondPoint)
        {
            ...
            var leftMembersDenominator = secondPoint.X - firstPoint.X;
            var rightMembersDenominator = secondPoint.Y - firstPoint.Y;
            var x = rightMembersDenominator;
            var x1 = -firstPoint.X * rightMembersDenominator;
            var y = leftMembersDenominator;
            var y1 = -firstPoint.Y * leftMembersDenominator;
            if (x < 0)
